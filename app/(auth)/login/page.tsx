...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center px-4 py-10 sm:px-6">
      ...
      <div
        className={`w-full max-w-5xl overflow-hidden rounded-3xl border border-slate-200 bg-white/90 shadow-2xl shadow-slate-200/80 backdrop-blur-xl transition-all duration-700 dark:border-white/15 dark:bg-[#0b101b]/90 dark:shadow-black/30 ${
      ...
      >
        <div className="grid lg:grid-cols-12">
          <div className="p-6 sm:p-10 lg:col-span-7 lg:p-12">
            ...
            <h1 className="mt-4 text-3xl font-semibold text-slate-900 sm:text-4xl dark:text-white">Welcome back</h1>
            ...
            <form onSubmit={handleLogin} className="mt-7 space-y-4">
              ...
              <button
                ...
                className="w-full rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium text-slate-900 transition hover:bg-slate-100 dark:border-white/20 dark:bg-white/5 dark:text-white dark:hover:bg-white/10"
              >
                Create new account
              </button>
            </form>
          ...
          <div className="hidden border-l border-slate-200 bg-gradient-to-b from-teal-100 to-cyan-50 p-10 dark:border-white/10 dark:from-teal-400/10 dark:to-cyan-400/5 lg:col-span-5 lg:block">
            <p className="text-xs uppercase tracking-[0.2em] text-teal-700 dark:text-teal-200">Operator Console</p>
            <h2 className="mt-3 text-2xl font-semibold text-slate-900 dark:text-white">Control your daily desk flow</h2>
            ...
            <div className="mt-7 space-y-3 text-sm text-slate-700 dark:text-slate-200">
              <div className="flex items-start gap-2 rounded-xl border border-slate-200 bg-white/70 p-3 dark:border-white/10 dark:bg-black/20">
